...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony default export */ __webpack_exports__["default"] = ("<div class=\"centered-container\">\r\n    <div class=\"panel\">\r\n        <div class=\"panel-heading\"> Калькулятор средней зарплаты </div>\r\n        <div class=\"tabs is-fullwidth\">\r\n            <ul>\r\n                <li routerLinkActive=\"is-active\"><i\r\n                        class=\"fas fa-balance-scale\"\r\n                        aria-hidden=\"true\"\r\n                    ></i>\r\n                    <a routerLink=\"/calculator/average\">Средняя за год</a>\r\n                </li>\r\n                <li routerLinkActive=\"is-active\"> <i\r\n                        class=\"far fa-calendar-alt\"\r\n                        aria-hidden=\"true\"\r\n                    ></i><a routerLink=\"/calculator/month\">За конкретный месяц </a></li>\r\n                <li routerLinkActive=\"is-active\"><i\r\n                        class=\"fas fa-cog\"\r\n                        aria-hidden=\"true\"\r\n                    ></i>\r\n                    <a routerLink=\"/settings\">Настройки</a>\r\n                </li>\r\n            </ul>\r\n        </div>\r\n        <router-outlet></router-outlet>\r\n        <app-loader *ngIf=\"loading$ | async\"></app-loader>\r\n    </div>\r\n    <app-page-footer></app-page-footer>\r\n</div>");
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony default export */ __webpack_exports__["default"] = ("<ng-container>\n    <div *ngIf=\"formType === formTypes.AverageMonthlySalary\" class=\"result-item\">\n        <h3>Ваш средний заработок в месяц (net):</h3>\n        <p *ngIf=\"calculationResults\">{{calculationResults?.averageMonthlySalary}} руб.</p>\n    </div>\n    <div *ngIf=\"formType === formTypes.AverageMonthlySalary\" class=\"result-item\">\n        <h3>Общий доход за год (net):</h3>\n        <p *ngIf=\"calculationResults\">{{calculationResults?.annualIncome}} руб.</p>\n    </div>\n    <div *ngIf=\"formType === formTypes.SalaryForGivenMonth\" class=\"result-item\">\n        <h3>Ваш заработок за {{(calculationResults?.month | lowercase) || '...'}} (net):</h3>\n        <p *ngIf=\"calculationResults\">{{calculationResults?.salaryForGivenMonth}} руб.</p>\n    </div>\n</ng-container>");
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony default export */ __webpack_exports__["default"] = ("<ng-container>\n        <p>\n            Created with <strong>love</strong> in Saint-Petersburg. Check out the source code at <a href=\"https://github.com/kristina-tregubova/average-salary-calculator\"> my github repository</a>.\n        </p>\n    </ng-container>");
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony default export */ __webpack_exports__["default"] = ("<div class=\"loader-wrapper\">\n    <div class=\"loader\"></div>\n</div>");
...
/* harmony import */ var _calculator_panel_calculator_panel_component__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./calculator-panel/calculator-panel.component */ "./src/app/calculator-panel/calculator-panel.component.ts");
...
const routes = [
    { path: 'calculator/average', component: _calculator_panel_calculator_panel_component__WEBPACK_IMPORTED_MODULE_3__["CalculatorPanelComponent"] },
    { path: 'calculator/month', component: _calculator_panel_calculator_panel_component__WEBPACK_IMPORTED_MODULE_3__["CalculatorPanelComponent"] },
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony default export */ __webpack_exports__["default"] = (".centered-container {\n  display: flex;\n  flex-direction: column;\n  justify-content: center;\n  align-items: center;\n  height: 100%;\n  width: 100%;\n}\n.centered-container .panel {\n  display: flex;\n  flex-direction: column;\n  width: 65%;\n  max-width: 750px;\n  min-width: 520px;\n  height: 75%;\n  position: relative;\n  background-color: #f8f8f8;\n}\n.centered-container .tabs {\n  font-size: 1.1rem;\n  font-weight: bold;\n  margin-bottom: 0;\n  height: 70px;\n}\n.centered-container .tabs ul {\n  border: 0;\n}\n.centered-container app-page-footer {\n  position: absolute;\n  bottom: 0;\n  margin-bottom: 2%;\n}\n/*# sourceMappingURL=data:application/json;base64, */");
...
/* harmony import */ var _calculator_panel_form_form_component__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./calculator-panel/form/form.component */ "./src/app/calculator-panel/form/form.component.ts");
/* harmony import */ var _page_footer_page_footer_component__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./page-footer/page-footer.component */ "./src/app/page-footer/page-footer.component.ts");
/* harmony import */ var _calculator_panel_results_results_component__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./calculator-panel/results/results.component */ "./src/app/calculator-panel/results/results.component.ts");
...
/* harmony import */ var _calculator_panel_calculator_panel_component__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ./calculator-panel/calculator-panel.component */ "./src/app/calculator-panel/calculator-panel.component.ts");
/* harmony import */ var _angular_forms__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! @angular/forms */ "./node_modules/@angular/forms/fesm2015/forms.js");
/* harmony import */ var _angular_common_http__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! @angular/common/http */ "./node_modules/@angular/common/fesm2015/http.js");
/* harmony import */ var _services_request_interceptor__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(/*! ./services/request.interceptor */ "./src/app/services/request.interceptor.ts");
...
AppModule = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_2__["NgModule"])({
        declarations: [
            ...
            _calculator_panel_calculator_panel_component__WEBPACK_IMPORTED_MODULE_9__["CalculatorPanelComponent"],
            _calculator_panel_form_form_component__WEBPACK_IMPORTED_MODULE_5__["FormComponent"],
            _page_footer_page_footer_component__WEBPACK_IMPORTED_MODULE_6__["PageFooterComponent"],
            _calculator_panel_results_results_component__WEBPACK_IMPORTED_MODULE_7__["ResultsComponent"],
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "CalculatorPanelComponent", function() { return CalculatorPanelComponent; });
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js");
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm2015/core.js");
/* harmony import */ var _models_form__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../models/form */ "./src/app/models/form.ts");
...
let CalculatorPanelComponent = class CalculatorPanelComponent {
    constructor(router) {
        this.router = router;
        this.router.url.pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["map"])((segments) => segments.join("/"))).subscribe((res) => this.currentUrl = res);
    }
    ngOnInit() {
        this.defineFormType();
    }
    ...
    defineFormType() {
        this.formType = this.currentUrl.includes(_models_form__WEBPACK_IMPORTED_MODULE_2__["FormType"].AverageMonthlySalary)
            ? _models_form__WEBPACK_IMPORTED_MODULE_2__["FormType"].AverageMonthlySalary
            : _models_form__WEBPACK_IMPORTED_MODULE_2__["FormType"].SalaryForGivenMonth;
    }
};
CalculatorPanelComponent.ctorParameters = () => [
    { type: _angular_router__WEBPACK_IMPORTED_MODULE_3__["ActivatedRoute"] }
];
CalculatorPanelComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
        selector: 'app-calculator-panel',
        template: tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(/*! raw-loader!./calculator-panel.component.html */ "./node_modules/raw-loader/dist/cjs.js!./src/app/calculator-panel/calculator-panel.component.html")).default,
        changeDetection: _angular_core__WEBPACK_IMPORTED_MODULE_1__["ChangeDetectionStrategy"].OnPush,
        styles: [tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(/*! ./calculator-panel.component.scss */ "./src/app/calculator-panel/calculator-panel.component.scss")).default]
    })
...
/* harmony import */ var _models_helper__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../../models/helper */ "./src/app/models/helper.ts");
/* harmony import */ var _services_calculator_service__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ../../services/calculator.service */ "./src/app/services/calculator.service.ts");
/* harmony import */ var _models_form__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ../../models/form */ "./src/app/models/form.ts");
...
], FormComponent.prototype, "formType", void 0);
tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Output"])()
], FormComponent.prototype, "gotCalculationResults", void 0);
FormComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
        selector: 'app-form',
        template: tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(/*! raw-loader!./form.component.html */ "./node_modules/raw-loader/dist/cjs.js!./src/app/calculator-panel/form/form.component.html")).default,
        changeDetection: _angular_core__WEBPACK_IMPORTED_MODULE_1__["ChangeDetectionStrategy"].OnPush,
        styles: [tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(/*! ./form.component.scss */ "./src/app/calculator-panel/form/form.component.scss")).default]
    })
], FormComponent);
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony default export */ __webpack_exports__["default"] = (":host {\n  position: absolute;\n  bottom: 0;\n  margin-bottom: 7%;\n}\n:host .result-item {\n  min-height: 100px;\n}\n:host .result-item:only-child {\n  min-height: 160px;\n}\n:host .result-item:not(:last-child) {\n  margin-bottom: 5%;\n}\n:host .result-item h3 {\n  font-size: 1.3em;\n  font-weight: bold;\n  color: #004550;\n}\n:host .result-item p {\n  font-size: 2em;\n  font-weight: bold;\n  color: #93ea20;\n}\n/*# sourceMappingURL=data:application/json;base64, */");
...
tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Input"])()
], ResultsComponent.prototype, "calculationResults", void 0);
tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Input"])()
], ResultsComponent.prototype, "formType", void 0);
ResultsComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
        selector: 'app-results',
        template: tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(/*! raw-loader!./results.component.html */ "./node_modules/raw-loader/dist/cjs.js!./src/app/calculator-panel/results/results.component.html")).default,
        changeDetection: _angular_core__WEBPACK_IMPORTED_MODULE_1__["ChangeDetectionStrategy"].OnPush,
        styles: [tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(/*! ./results.component.scss */ "./src/app/calculator-panel/results/results.component.scss")).default]
    })
], ResultsComponent);
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "onlyNumbersRegExp", function() { return onlyNumbersRegExp; });
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js");
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "Indices", function() { return Indices; });
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js");
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony default export */ __webpack_exports__["default"] = (":host {\n  color: #f8f8f8;\n}\n:host strong {\n  color: #93ea20;\n}\n/*# sourceMappingURL=data:application/json;base64, */");
...
PageFooterComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
        ...
        template: tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(/*! raw-loader!./page-footer.component.html */ "./node_modules/raw-loader/dist/cjs.js!./src/app/page-footer/page-footer.component.html")).default,
        styles: [tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(/*! ./page-footer.component.scss */ "./src/app/page-footer/page-footer.component.scss")).default]
    })
], PageFooterComponent);
...
let CalculatorService = class CalculatorService {
    ...
    sendFormData(formData) {
        const url = `${_environments_environment__WEBPACK_IMPORTED_MODULE_3__["environment"].baseUrl}/sendFormData`;
        return this.http.post(url, formData);
    }
    getCurrentIndices() {
        const url = `${_environments_environment__WEBPACK_IMPORTED_MODULE_3__["environment"].baseUrl}/getCurrentIndices`;
        return this.http.get(url);
    }
    setCustomIndices(indices) {
        const url = `${_environments_environment__WEBPACK_IMPORTED_MODULE_3__["environment"].baseUrl}/setCustomIndices`;
        return this.http.put(url, indices);
    }
    resetCustomIndex(key) {
        const keyValuePair = { keyName: key };
        const url = `${_environments_environment__WEBPACK_IMPORTED_MODULE_3__["environment"].baseUrl}/resetCustomIndex`;
        return this.http.put(url, keyValuePair);
    }
    resetAllIndices() {
        const url = `${_environments_environment__WEBPACK_IMPORTED_MODULE_3__["environment"].baseUrl}/resetAllIndices`;
        return this.http.get(url);
    }
};
...
let RequestInterceptor = class RequestInterceptor {
    ...
    intercept(request, next) {
        ...
        return next.handle(request).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["finalize"])(() => this.loader.stopLoading()));
        ;
    }
};
...
/* harmony import */ var _models_helper__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../models/helper */ "./src/app/models/helper.ts");
/* harmony import */ var _services_calculator_service__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ../services/calculator.service */ "./src/app/services/calculator.service.ts");
/* harmony import */ var _models_indices__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ../models/indices */ "./src/app/models/indices.ts");
...
let SettingsComponent = class SettingsComponent {
    constructor(calculatorService, detector) {
        this.calculatorService = calculatorService;
    ...
    getCurrentIndexValue() {
        this.calculatorService.getCurrentIndices().subscribe((value) => {
            this.setNewIndicesValue(value);
        });
    }
    onFormSubmit() {
        this.calculatorService.setCustomIndices(this.formData.value).subscribe((value) => {
            this.setNewIndicesValue(value);
        }); // todo: add error handling
    }
    onResetClick(key) {
        this.calculatorService.resetCustomIndex(key).subscribe((value) => {
            this.setNewIndicesValue(value);
        });
    }
    onResetAllClick() {
        this.calculatorService.resetAllIndices().subscribe((value) => {
            this.setNewIndicesValue(value);
        });
    }
    setNewIndicesValue(value) {
...
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js");
/* harmony import */ var _config_default_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../../../config/default.js */ "../config/default.js");
...
module.exports = __webpack_require__(/*! C:\Users\ktikhono\Desktop\average-salary-calculator\client\src\main.ts */"./src/main.ts");
